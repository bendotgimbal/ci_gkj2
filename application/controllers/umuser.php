...
class umuser extends CI_Controller {
    ...
    public function index() {
        if ($this->session->userdata('sess_apps') == TRUE) {
            ...
            $TABLE                  = "SELECT (a.um_user_id)um_user_id, (a.u_id)u_id, (b.tbluk_nik)nik, (a.nama)nama, (a.password)password, (a.username)username, (c.no_induk)no_induk, (c.Field1)no_kk, (c.nama)nama2 FROM tbl_um_user a INNER JOIN tbl_user_akses b on b.tbluk_u_id=a.u_id INNER JOIN tbl_induk c on c.nik=b.tbluk_nik WHERE a.u_id ORDER BY a.um_user_id ASC";
            $data['dataAll']        = $this->mod_umuser->getQuery($TABLE);
