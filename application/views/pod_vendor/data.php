<form enctype="multipart/form-data" action="<?php echo base_url('pod_vendor/savedata/'); ?>" method="post" name="defaultForm"  class="form-horizontal">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="waybill"  id="waybill" style="width:60%;" required>
								...
								<?php $iLoop = 1; foreach($AwbVendor->result() as $rsData): ?>
									<option value="<?php echo $rsData->mswb_nomor."|".$rsData->tvve_tanggal; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="tipe_pod"  id="tipe_pod" style="width:60%;" required>
                                <option value="" selected>-- Tipe Penerima --</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="penerima" id="penerima" class="form-control input-sm"  style="width: 60%;" value="" required>
                        ...
                        <div class="form-group" Hidden="true">
                  				...
                  				<div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                    <input type="text" class="form-control" disabled="disabled" name="jam_sip" id="jam_sip"  value="<?php echo date('G:i', strtotime('-135 minutes')); ?>" required>
              			...
              			<div class="form-group">
                  				<label class="col-sm-3">Jam POD *</label>
                  				<div class="input-group clockpicker"  data-align="top" data-autoclose="true" required>
                                    <input type="text" class="form-control" name="jam_pod" id="jam_pod"  value="<?php echo date('G:i'); ?>" data-inputmask="'alias': 'hh:mm'" data-mask required>
								</div>
              			</div>
...
<script>
	...
	$('#jam_pod').change( function() {
		var timeA = $("#jam_pod").val();
		var n = timeA.indexOf("_");
		if (n > -1) {
			alert("Salah Pengisian Format Waktu POD");
		};
    ...
    $("#jam_pod").inputmask("hh:mm", {"placeholder": "hh:mm"});
    $("[data-mask]").inputmask();
    ...
    $(document).ready(function(){
	    $("form").submit(function(){
	        var jam_pod = $('#jam_pod').val();
	        var jam_pod_regex = /(2[0-4]|[01][1-9]|10):([0-5][0-9])/;
	        if (!jam_pod.match(jam_pod_regex) || jam_pod.length == 0) {
	        	alert("Salah Pengisian Format Waktu POD");
	        	$("#jam_pod").focus();
	        	return false;
	        } else {
    ...
    {
    	var format_jam_pod = document.getElementById("jam_pod").value;
    	if (format_jam_pod!="") {
    		$("#waiting").show();
			$.ajax({
				type: "POST",
				url: "pod_vendor/getValidationTime",
				data: {"jam_pod":format_jam_pod},
				timeout: 10000,
				beforeSend: function(){},
				complete: function(){},
				cache: false,
