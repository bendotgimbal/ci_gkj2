<form enctype="multipart/form-data" action="<?php echo base_url('dex/savedata/'); ?>" method="post" name="defaultForm" id="defaultForm"  class="form-horizontal">
                ...
                <div class="box-body" style="padding: 20px;">
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="mswb_pk" id="mswb_pk" class="form-control input-sm"  style="width: 60%;" value="">
						...
						<div class="form-group">
                            <label class="col-sm-3">Alasan DEX</label>
						...
						<div class="form-group">
                            <label class="col-sm-3">Tanggal Dex *</label>
                        ...
                        <div class="form-group">
               			...
               			<div class="form-group">
                            <label class="col-sm-3">Keterangan Lainnya</label>
