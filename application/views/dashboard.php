...
<!--================================== KATEGORI 01 sidebar menu: : style can be found in sidebar.less GD212==================================-->
                ...
                $getMenu   = $this->db->query("SELECT * FROM v_um3 WHERE um_user_id =".$this->session->userdata('sess_apps_uid')." AND parenturl = 0 and tipemenu <> 'Form' ORDER BY um_menu_id ASC");
                $strActive_det = "";
                $i=1;
                        ...
                        ?>
                            ...
                            <li class="<?php echo  $strActive_header; ?>">
                                ...
                                <?php
                                    ...
                                    $getDetail = $this->db->query("SELECT * FROM v_um3 WHERE um_user_id =".$this->session->userdata('sess_apps_uid')." AND parenturl = ".$rsMenu->um_menu_id ." and tipemenu = 'List' ORDER BY um_menu_id ASC");
